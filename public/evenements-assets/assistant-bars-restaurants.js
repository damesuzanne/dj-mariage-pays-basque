    ...
    (function () {
      ...
      configElement.textContent = "{\"ctaTitle\": \"Et si cet assistant travaillait pour votre activité ?\", \"ctaText\": \"Une landing page conçue pour convertir, avec votre chatbot IA personnalisé et inclus sur demande.\", \"ctaLabel\": \"Lancez votre projet\", \"ctaHref\": \"https://www.htags.fr/contact/\", \"source\": \"https://djmariagepaysbasque.fr/bars-restaurants/\", \"match\": \"/__richard-dj__/\", \"name\": \"Assistant Richard DJ\", \"launcher\": \"Assistant Richard DJ\", \"qualify\": true, \"qualificationMode\": \"dj\", \"theme\": {\"accent\": \"#c6a15b\", \"accentDark\": \"#101522\", \"header\": \"#101522\", \"ink\": \"#23283a\", \"soft\": \"#faf7f1\", \"bodyFont\": \"Outfit, 'Helvetica Neue', Arial, sans-serif\", \"controlFont\": \"Outfit, 'Helvetica Neue', Arial, sans-serif\", \"headingFont\": \"'Playfair Display', Georgia, serif\"}, \"summaryTitle\": \"Aperçu de votre soirée en établissement\", \"mailSubject\": \"Demande soirée en établissement\", \"identityBadge\": \"Contact identifié\", \"fieldsByIntent\": {\"Demande de disponibilité\": [[\"Demande\", \"intent\"], [\"Date de votre soirée en établissement\", \"date\"], [\"Secteur\", \"location\"], [\"Confirmation du projet\", \"projectStage\"], [\"Recherche de DJ\", \"djSearchStatus\"]], \"Préparer mon événement\": [[\"Demande\", \"intent\"], [\"Date de votre soirée en établissement\", \"date\"], [\"Secteur\", \"location\"], [\"Lieu de réception\", \"venue\"], [\"Nombre d’invités\", \"guests\"], [\"Moments à sonoriser\", \"moments\"], [\"Prestations souhaitées\", \"services\"], [\"Ambiance musicale\", \"music\"], [\"Avancement du projet\", \"projectStage\"], [\"Recherche de DJ\", \"djSearchStatus\"]]}, \"start\": \"start\", \"steps\": {\"start\": {\"key\": \"intent\", \"message\": \"Bonjour ! Je vous aide à préparer une soirée musicale dans votre bar ou restaurant. Quel est votre projet ?\", \"choices\": [[\"Demande de disponibilité\", \"dj_availability_date\"], [\"Préparer mon événement\", \"dj_project_date\"], [\"Découvrir les prestations\", \"dj_services_info\"], [\"Être rappelé par Richard\", \"callback\"], [\"Coordonnées & zone d’intervention\", \"contact_info\"]]}, \"dj_availability_date\": {\"dateInput\": true, \"key\": \"date\", \"message\": \"À quelle date aura lieu votre soirée en établissement ?\", \"label\": \"Date de votre soirée en établissement\", \"buttonLabel\": \"Valider cette date\", \"next\": \"dj_availability_location\"}, \"dj_availability_location\": {\"key\": \"location\", \"message\": \"Dans quel secteur se déroulera votre soirée en établissement ?\", \"choices\": [[\"Bayonne / Anglet\", \"dj_availability_stage\"], [\"Biarritz\", \"dj_availability_stage\"], [\"Saint-Jean-de-Luz / Hendaye\", \"dj_availability_stage\"], [\"Pays Basque intérieur\", \"dj_availability_stage\"], [\"Landes / Hossegor / Dax\", \"dj_availability_stage\"], [\"Autre secteur\", \"dj_availability_stage\"]]}, \"dj_availability_stage\": {\"key\": \"projectStage\", \"message\": \"La date et le lieu de votre soirée en établissement sont-ils déjà confirmés ?\", \"choices\": [[\"Oui, la date et le lieu sont confirmés\", \"dj_search_status\"], [\"La date est confirmée, le lieu reste à choisir\", \"dj_search_status\"], [\"La date est encore flexible\", \"dj_search_status\"]]}, \"dj_project_date\": {\"dateInput\": true, \"key\": \"date\", \"message\": \"Commençons par la date prévue pour votre soirée en établissement.\", \"label\": \"Date de votre soirée en établissement\", \"buttonLabel\": \"Valider cette date\", \"next\": \"dj_project_location\"}, \"dj_project_location\": {\"key\": \"location\", \"message\": \"Dans quel secteur se déroulera votre soirée en établissement ?\", \"choices\": [[\"Bayonne / Anglet\", \"dj_venue\"], [\"Biarritz\", \"dj_venue\"], [\"Saint-Jean-de-Luz / Hendaye\", \"dj_venue\"], [\"Pays Basque intérieur\", \"dj_venue\"], [\"Landes / Hossegor / Dax\", \"dj_venue\"], [\"Autre secteur\", \"dj_venue\"]]}, \"dj_venue\": {\"key\": \"venue\", \"message\": \"Quel est le nom du lieu de réception ? Si vous ne l’avez pas encore choisi, indiquez simplement « à définir ».\", \"input\": {\"type\": \"text\", \"label\": \"Lieu de réception\", \"placeholder\": \"Ex. : Nom du bar ou restaurant\", \"maxlength\": 100, \"buttonLabel\": \"Valider le lieu\"}, \"next\": \"dj_guests\"}, \"dj_guests\": {\"key\": \"guests\", \"message\": \"Combien d’invités prévoyez-vous approximativement ?\", \"input\": {\"type\": \"number\", \"label\": \"Nombre d’invités\", \"placeholder\": \"Ex. : 120\", \"min\": 1, \"suffix\": \" invités\", \"buttonLabel\": \"Valider\"}, \"next\": \"dj_moments\"}, \"dj_moments\": {\"multi\": true, \"key\": \"moments\", \"message\": \"Quels moments souhaitez-vous confier à Richard ?\", \"choices\": [\"Apéritif / afterwork\", \"Dîner musical\", \"Soirée festive\", \"Privatisation\"], \"buttonLabel\": \"Valider les moments\", \"next\": \"dj_options_choice\"}, \"dj_options_choice\": {\"message\": \"Souhaitez-vous ajouter des prestations complémentaires ?\", \"choices\": [[\"Oui, choisir mes options\", \"dj_options\"], [\"Non, pas pour le moment\", \"dj_music\", \"Aucune option pour le moment\", \"services\"]]}, \"dj_options\": {\"multi\": true, \"key\": \"services\", \"message\": \"Quelles prestations complémentaires vous intéressent ?\", \"choices\": [\"Sonorisation & micros\", \"Éclairage d’ambiance\", \"Photobooth\", \"Vidéoprojection & écran\"], \"buttonLabel\": \"Valider les prestations\", \"next\": \"dj_music\"}, \"dj_music\": {\"key\": \"music\", \"message\": \"Avez-vous déjà une idée précise pour la musique de votre soirée en établissement ?\", \"choices\": [[\"Oui, préciser mon idée\", \"dj_music_custom\"], [\"Un mélange totalement personnalisé\", \"dj_stage\"], [\"À définir avec Richard\", \"dj_stage\"]]}, \"dj_music_custom\": {\"key\": \"music\", \"message\": \"Décrivez librement votre thème, un style musical ou une idée très précise.\", \"input\": {\"type\": \"text\", \"label\": \"Votre idée musicale\", \"placeholder\": \"Ex. : une soirée reggae, un thème cinéma, beaucoup de rock…\", \"maxlength\": 180, \"buttonLabel\": \"Valider mon idée\"}, \"next\": \"dj_stage\"}, \"dj_stage\": {\"key\": \"projectStage\", \"message\": \"Où en est aujourd’hui l’organisation de votre soirée en établissement ?\", \"choices\": [[\"La date et le lieu sont confirmés\", \"dj_search_status\"], [\"La date est confirmée, le lieu reste à choisir\", \"dj_search_status\"], [\"L’organisation est en cours\", \"dj_search_status\"], [\"Je prends simplement des renseignements\", \"dj_search_status\"]]}, \"dj_search_status\": {\"key\": \"djSearchStatus\", \"message\": \"Où en êtes-vous dans votre recherche de DJ ?\", \"choices\": [[\"Je commence mes recherches\", \"contact\"], [\"Je compare plusieurs DJ\", \"contact\"], [\"J’ai déjà reçu un ou plusieurs devis\", \"contact\"], [\"Notre choix est presque arrêté\", \"contact\"], [\"Nous devons remplacer un DJ devenu indisponible\", \"contact\"]]}, \"dj_services_info\": {\"info\": true, \"message\": \"PRESTATIONS POUR LES BARS & RESTAURANTS\\n\\n• DJ & ambiance musicale pour apéritifs, dîners et soirées festives\\n• Sonorisation adaptée à votre salle ou terrasse et micros\\n• Éclairage d’ambiance et de la piste de danse\\n• Photobooth\\n• Vidéoprojection et écran\\n• Privatisations, lancements de saison et soirées spéciales\", \"choices\": [[\"Préparer mon événement\", \"dj_project_date\", \"Préparer mon événement\", \"intent\"], [\"Demande de disponibilité\", \"dj_availability_date\", \"Demande de disponibilité\", \"intent\"], [\"Revenir au menu principal\", \"start\"]]}, \"contact_info\": {\"info\": true, \"message\": \"RICHARD DJ EVENT\\nBasé au Pays basque · Interventions au Pays basque et dans les Landes\\n\\n06 84 33 18 24\\nricharddjevent@gmail.com\\n\\nDisponible 7j/7 sur rendez-vous · Réponse sous 24 h.\", \"choices\": [[\"Être rappelé par Richard\", \"callback\"], [\"Appeler Richard\", \"tel:+33684331824\"], [\"Écrire à Richard\", \"mailto:richarddjevent@gmail.com\"], [\"Préparer mon événement\", \"dj_project_date\", \"Préparer mon événement\", \"intent\"], [\"Revenir au menu principal\", \"start\"]]}}, \"realLive\": true, \"realPreview\": false, \"autoOpen\": false, \"contactEndpoint\": \"/api/contact\", \"recipient\": \"richarddjevent@gmail.com\", \"turnstileSiteKey\": \"0x4AAAAAADxOwNEZbVFGF9_e\"}";
