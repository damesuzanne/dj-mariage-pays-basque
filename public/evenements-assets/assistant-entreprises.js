    ...
    (function () {
      ...
      configElement.textContent = "{\"ctaTitle\": \"Et si cet assistant travaillait pour votre activité ?\", \"ctaText\": \"Une landing page conçue pour convertir, avec votre chatbot IA personnalisé et inclus sur demande.\", \"ctaLabel\": \"Lancez votre projet\", \"ctaHref\": \"https://www.htags.fr/contact/\", \"source\": \"https://djmariagepaysbasque.fr/entreprises/\", \"match\": \"/__richard-dj__/\", \"name\": \"Assistant Richard DJ\", \"launcher\": \"Assistant Richard DJ\", \"qualify\": true, \"qualificationMode\": \"dj\", \"theme\": {\"accent\": \"#c6a15b\", \"accentDark\": \"#101522\", \"header\": \"#101522\", \"ink\": \"#23283a\", \"soft\": \"#faf7f1\", \"bodyFont\": \"Outfit, 'Helvetica Neue', Arial, sans-serif\", \"controlFont\": \"Outfit, 'Helvetica Neue', Arial, sans-serif\", \"headingFont\": \"'Playfair Display', Georgia, serif\"}, \"summaryTitle\": \"Aperçu de votre événement d’entreprise\", \"mailSubject\": \"Demande événement d’entreprise\", \"identityBadge\": \"Contact identifié\", \"fieldsByIntent\": {\"Demande de disponibilité\": [[\"Demande\", \"intent\"], [\"Date de votre événement d’entreprise\", \"date\"], [\"Secteur\", \"location\"], [\"Confirmation du projet\", \"projectStage\"], [\"Recherche de DJ\", \"djSearchStatus\"]], \"Préparer mon événement\": [[\"Demande\", \"intent\"], [\"Date de votre événement d’entreprise\", \"date\"], [\"Secteur\", \"location\"], [\"Lieu de réception\", \"venue\"], [\"Nombre d’invités\", \"guests\"], [\"Moments à sonoriser\", \"moments\"], [\"Prestations souhaitées\", \"services\"], [\"Ambiance musicale\", \"music\"], [\"Avancement du projet\", \"projectStage\"], [\"Recherche de DJ\", \"djSearchStatus\"]]}, \"start\": \"start\", \"steps\": {\"start\": {\"key\": \"intent\", \"message\": \"Bonjour ! Je vous aide à préparer votre soirée d’entreprise, séminaire ou événement clients. Quel est votre projet ?\", \"choices\": [[\"Demande de disponibilité\", \"dj_availability_date\"], [\"Préparer mon événement\", \"dj_project_date\"], [\"Découvrir les prestations\", \"dj_services_info\"], [\"Être rappelé par Richard\", \"callback\"], [\"Coordonnées & zone d’intervention\", \"contact_info\"]]}, \"dj_availability_date\": {\"dateInput\": true, \"key\": \"date\", \"message\": \"À quelle date aura lieu votre événement d’entreprise ?\", \"label\": \"Date de votre événement d’entreprise\", \"buttonLabel\": \"Valider cette date\", \"next\": \"dj_availability_location\"}, \"dj_availability_location\": {\"key\": \"location\", \"message\": \"Dans quel secteur se déroulera votre événement d’entreprise ?\", \"choices\": [[\"Bayonne / Anglet\", \"dj_availability_stage\"], [\"Biarritz\", \"dj_availability_stage\"], [\"Saint-Jean-de-Luz / Hendaye\", \"dj_availability_stage\"], [\"Pays Basque intérieur\", \"dj_availability_stage\"], [\"Landes / Hossegor / Dax\", \"dj_availability_stage\"], [\"Autre secteur\", \"dj_availability_stage\"]]}, \"dj_availability_stage\": {\"key\": \"projectStage\", \"message\": \"La date et le lieu de votre événement d’entreprise sont-ils déjà confirmés ?\", \"choices\": [[\"Oui, la date et le lieu sont confirmés\", \"dj_search_status\"], [\"La date est confirmée, le lieu reste à choisir\", \"dj_search_status\"], [\"La date est encore flexible\", \"dj_search_status\"]]}, \"dj_project_date\": {\"dateInput\": true, \"key\": \"date\", \"message\": \"Commençons par la date prévue pour votre événement d’entreprise.\", \"label\": \"Date de votre événement d’entreprise\", \"buttonLabel\": \"Valider cette date\", \"next\": \"dj_project_location\"}, \"dj_project_location\": {\"key\": \"location\", \"message\": \"Dans quel secteur se déroulera votre événement d’entreprise ?\", \"choices\": [[\"Bayonne / Anglet\", \"dj_venue\"], [\"Biarritz\", \"dj_venue\"], [\"Saint-Jean-de-Luz / Hendaye\", \"dj_venue\"], [\"Pays Basque intérieur\", \"dj_venue\"], [\"Landes / Hossegor / Dax\", \"dj_venue\"], [\"Autre secteur\", \"dj_venue\"]]}, \"dj_venue\": {\"key\": \"venue\", \"message\": \"Quel est le nom du lieu de réception ? Si vous ne l’avez pas encore choisi, indiquez simplement « à définir ».\", \"input\": {\"type\": \"text\", \"label\": \"Lieu de réception\", \"placeholder\": \"Ex. : Centre de séminaire\", \"maxlength\": 100, \"buttonLabel\": \"Valider le lieu\"}, \"next\": \"dj_guests\"}, \"dj_guests\": {\"key\": \"guests\", \"message\": \"Combien d’invités prévoyez-vous approximativement ?\", \"input\": {\"type\": \"number\", \"label\": \"Nombre d’invités\", \"placeholder\": \"Ex. : 120\", \"min\": 1, \"suffix\": \" invités\", \"buttonLabel\": \"Valider\"}, \"next\": \"dj_moments\"}, \"dj_moments\": {\"multi\": true, \"key\": \"moments\", \"message\": \"Quels moments souhaitez-vous confier à Richard ?\", \"choices\": [\"Accueil / cocktail\", \"Repas\", \"Discours / présentation\", \"Soirée dansante\"], \"buttonLabel\": \"Valider les moments\", \"next\": \"dj_options_choice\"}, \"dj_options_choice\": {\"message\": \"Souhaitez-vous ajouter des prestations complémentaires ?\", \"choices\": [[\"Oui, choisir mes options\", \"dj_options\"], [\"Non, pas pour le moment\", \"dj_music\", \"Aucune option pour le moment\", \"services\"]]}, \"dj_options\": {\"multi\": true, \"key\": \"services\", \"message\": \"Quelles prestations complémentaires vous intéressent ?\", \"choices\": [\"Sonorisation & micros\", \"Éclairage d’ambiance\", \"Photobooth\", \"Vidéoprojection & écran\"], \"buttonLabel\": \"Valider les prestations\", \"next\": \"dj_music\"}, \"dj_music\": {\"key\": \"music\", \"message\": \"Avez-vous déjà une idée précise pour la musique de votre événement d’entreprise ?\", \"choices\": [[\"Oui, préciser mon idée\", \"dj_music_custom\"], [\"Un mélange totalement personnalisé\", \"dj_stage\"], [\"À définir avec Richard\", \"dj_stage\"]]}, \"dj_music_custom\": {\"key\": \"music\", \"message\": \"Décrivez librement votre thème, un style musical ou une idée très précise.\", \"input\": {\"type\": \"text\", \"label\": \"Votre idée musicale\", \"placeholder\": \"Ex. : une soirée reggae, un thème cinéma, beaucoup de rock…\", \"maxlength\": 180, \"buttonLabel\": \"Valider mon idée\"}, \"next\": \"dj_stage\"}, \"dj_stage\": {\"key\": \"projectStage\", \"message\": \"Où en est aujourd’hui l’organisation de votre événement d’entreprise ?\", \"choices\": [[\"La date et le lieu sont confirmés\", \"dj_search_status\"], [\"La date est confirmée, le lieu reste à choisir\", \"dj_search_status\"], [\"L’organisation est en cours\", \"dj_search_status\"], [\"Je prends simplement des renseignements\", \"dj_search_status\"]]}, \"dj_search_status\": {\"key\": \"djSearchStatus\", \"message\": \"Où en êtes-vous dans votre recherche de DJ ?\", \"choices\": [[\"Je commence mes recherches\", \"contact\"], [\"Je compare plusieurs DJ\", \"contact\"], [\"J’ai déjà reçu un ou plusieurs devis\", \"contact\"], [\"Notre choix est presque arrêté\", \"contact\"], [\"Nous devons remplacer un DJ devenu indisponible\", \"contact\"]]}, \"dj_services_info\": {\"info\": true, \"message\": \"PRESTATIONS POUR LES ENTREPRISES\\n\\n• DJ & ambiance musicale pour cocktails, séminaires et soirées d’entreprise\\n• Sonorisation et micros pour discours et présentations\\n• Éclairage d’ambiance et de la piste de danse\\n• Photobooth\\n• Vidéoprojection et écran\\n• Réceptions, inaugurations et soirées spéciales\", \"choices\": [[\"Préparer mon événement\", \"dj_project_date\", \"Préparer mon événement\", \"intent\"], [\"Demande de disponibilité\", \"dj_availability_date\", \"Demande de disponibilité\", \"intent\"], [\"Revenir au menu principal\", \"start\"]]}, \"contact_info\": {\"info\": true, \"message\": \"RICHARD DJ EVENT\\nBasé au Pays basque · Interventions au Pays basque et dans les Landes\\n\\n06 84 33 18 24\\nricharddjevent@gmail.com\\n\\nDisponible 7j/7 sur rendez-vous · Réponse sous 24 h.\", \"choices\": [[\"Être rappelé par Richard\", \"callback\"], [\"Appeler Richard\", \"tel:+33684331824\"], [\"Écrire à Richard\", \"mailto:richarddjevent@gmail.com\"], [\"Préparer mon événement\", \"dj_project_date\", \"Préparer mon événement\", \"intent\"], [\"Revenir au menu principal\", \"start\"]]}}, \"realLive\": true, \"realPreview\": false, \"autoOpen\": false, \"contactEndpoint\": \"/api/contact\", \"recipient\": \"richarddjevent@gmail.com\", \"turnstileSiteKey\": \"0x4AAAAAADxOwNEZbVFGF9_e\"}";
...
(function () {
  ...
  var css = [
    ...
    "@media(max-width:620px){.launcher{left:max(12px,env(safe-area-inset-left));right:max(12px,env(safe-area-inset-right));bottom:max(12px,env(safe-area-inset-bottom));width:max-content;max-width:calc(100dvw - 100px);padding-right:13px}.panel{inset:max(8px,env(safe-area-inset-top)) max(8px,env(safe-area-inset-right)) max(8px,env(safe-area-inset-bottom)) max(8px,env(safe-area-inset-left));width:auto;height:auto;max-width:none;max-height:none;border-radius:18px}.head{padding:12px}.avatar{width:35px;height:35px}.identity strong{font-size:14px}.identity small{font-size:10.5px}.head-actions{gap:4px}.home{padding:7px 9px}.close{width:34px;height:34px}.conversation{padding:12px}.message{max-width:94%;font-size:15px}.choice{font-size:14px}.form input{font-size:16px}.grid{grid-template-columns:1fr}}"
  ].join("");
      ...
      if (isWeb) {
        ...
        control.addEventListener("click", function () {
          ...
          if (config.name.indexOf("Yoga") !== -1) {
            ...
            followups = [["Préparer mon événement", "dj_project_date"], ["Revenir au menu principal", "start"], ["Terminer la démonstration", "demo_end"]];
          } else {
  ...
  function showEventOther() {
    window.setTimeout(function () {
      ...
      var form = formShell("Votre événement", "<input name='value' type='text' maxlength='80' placeholder='Ex. : soirée privée' required>", "Valider l’événement");
      form.addEventListener("submit", function (event) {
        event.preventDefault();
    ...
    window.setTimeout(function () {
      if (config.realPreview || config.realLive) {
        ...
        realForm.innerHTML =
          ...
          "<p class='secure-note'>🔒 Aperçu local : aucune demande n’est envoyée.</p>" +
  ...
  function showRealSuccess(mode) {
    window.setTimeout(function () {
      ...
      item.innerHTML =
        ...
        (mode === "callback" ? "demande de rappel" : "projet événementiel") +
